...
export const defaultAppState: AppState = {
  foods: [
    ...
    },
    {
      ...
      icon: "🍔",
      unit: "patty",
      nutritionPerUnit: { carbs: 5, fat: 3, protein: 9 },
      price: 0.71
    },
    {
      id: "riced-veggies",
      ...
      icon: "🥦",
      unit: "85g",
      nutritionPerUnit: { carbs: 4, fat: 0, protein: 2 },
      price: 0.82
    },
    {
      id: "pineapple",
      ...
      icon: "🍍",
      unit: "140g",
      nutritionPerUnit: { carbs: 22, fat: 0.2, protein: 1 },
      price: 0.62,
    },
    {
      ...
      icon: "🥗",
      unit: "85g",
      nutritionPerUnit: { carbs: 5, fat: 0, protein: 3 },
      price: 0.5,
    },
    {
      id: "tj-oatmeal",
      name: "TJ Instant Oatmeal",
      icon: "🥣",
      unit: "packet",
      nutritionPerUnit: { carbs: 26, fat: 3, protein: 5 },
      price: 0.47,
    },
  ],
  pantry: [
    ...
    { foodId: "morningstar", stock: 2 },
    { foodId: "tj-oatmeal", stock: 8 },
